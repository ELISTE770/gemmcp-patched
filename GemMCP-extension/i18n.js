...
const I18N_DICT = {
  he: {
    ...
    runModeSub: 'מתי ג׳מיני רשאי לבצע פעולה בלי לעצור ולשאול אותך:',
    ...
    winPermInstallSub: 'מוריד קובץ exe או msi ומריץ אותו. זו הפעולה היחידה שמריצה קוד שלא ראית. תמיד שואלת לפני, וניתן לבטל מהפאנל.',
